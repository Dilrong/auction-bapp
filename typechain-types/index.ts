...
export type { AuctionRepository } from "./contracts/AuctionRepository";
export { AuctionRepository__factory } from "./factories/contracts/AuctionRepository__factory";
export type { DeedRepository } from "./contracts/DeedRepository";
export { DeedRepository__factory } from "./factories/contracts/DeedRepository__factory";
